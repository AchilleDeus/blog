  ...
  return (
    <div className="sidebar">
       ...
       <span  className="sidebarTitle">ABOUT ME</span>
          <img src="../immagini/logoTravelCaffe.png" alt="..." />
          <p className="abaut">
...
<span className="sidebarTitle">CATEGORIES</span>
       ...
       <ul className="sidebarList">
        <li className="sidebarListItem">Veneto</li>
        <li className="sidebarListItem">Toscana</li>
        <li className="sidebarListItem">Emiglia Romagna</li>
        <li className="sidebarListItem">Puglia</li>
        <li className="sidebarListItem">Sardegna</li>
